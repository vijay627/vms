...
<html>
  <head>
	...
	{	
		 ...
		 currentPage = window.opener.document.getElementById('currentPage').value; 
			...
			VmsDwrUtilities.getDriverDetails(
				   				fromDate,
				   				toDate,
				   				{
				   					async:true,
	...
	function getDriverCallBack(dataFromServer)
		{
			...
			for(var index=0; index<dataFromServer.length; index++)
			{
				...
				var selectedRow = new Number(this.rowIndex)-1;
					...
					window.opener.document.getElementById('driverId').value=dataFromServer[selectedRow].driverId;
					
					if(currentPage != 'V')
					{
						window.opener.document.getElementById('driverName').value=dataFromServer[selectedRow].firstName + ' '+dataFromServer[selectedRow].lastName ;
					}
				...
				cell1.innerHTML = dataFromServer[index].driverId; 				
				
				var cell2 = row.insertCell(1);             
				cell2.innerHTML = dataFromServer[index].firstName + ' '+dataFromServer[index].lastName; 				
				
				
				var cell3 = row.insertCell(2);             
				cell3.innerHTML = dataFromServer[index].mobileNumber;
  ...
  <body onload="fnOnload();">
			<div class="section" id="PopupDet" >
				<table id="driverTable" style="font-family: verdana; font-size: 12px;background-color: skyblue;margin-top:5px;margin-left:3%;margin-right:3%;width: 95%;" >
					<tr>
